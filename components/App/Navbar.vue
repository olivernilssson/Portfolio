      ...
      >
        <li v-for="item in items" :key="item.path">
          ...
          >
            <ULink
              :to="item.path"
              class="relative px-3 py-4 flex items-center justify-center transition hover:text-primary-600 dark:hover:text-primary-400"
        ...
        <li v-for="social in socials" :key="social.name">
          <ULink
            :to="social.path"
            target="_blank"
            class="px-3 py-4 flex items-center justify-center transition hover:text-primary-600 dark:hover:text-primary-400"
          >
            <Icon aria-hidden="true" :name="social.icon" class="w-5 h-5" />
...
const socials = [
   {
    name: "LinkedIn",
    path: "https://www.linkedin.com/in/oliver-nilsson-b994641aa/",
    icon: "mdi:linkedin",
  },
  {
    name: "GitHub",
    path: "https://github.com/olivernilssson",
    icon: "mdi:github",
  },
  {
    name: "Email",
    path: "mailto:olivernilsson@live.se",
    icon: "mdi:email",  
  },
];
</script>
